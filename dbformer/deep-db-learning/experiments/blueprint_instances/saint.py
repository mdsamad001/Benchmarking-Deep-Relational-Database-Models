...
def create_saint_model(
    ...
    return BlueprintModel(
        ...
        stype_encoder_dict=get_encoder("saint"),
        ...
        pre_combination=lambda i, node, cols: Sequential(
            ...
            [
                (
                    SelfAttention(embed_dim, num_heads=num_heads, dropout=dropout),
                    "x_in -> x_next",
                ),
                ...
                (
                    IntersampleAttention(
                        embed_dim, num_cols=len(cols), num_heads=num_heads, dropout=dropout
                    ),
                    "x_in -> x_next",
                ),
                (ResidualNorm(embed_dim), "x_in, x_next -> x_in"),
