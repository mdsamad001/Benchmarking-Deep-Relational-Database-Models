...
autocomplete_clf_tasks = [
    ...
    ("rel-trial",  "eligibilities", "adult",  ["child","older_adult","minimum_age","maximum_age","population","criteria","gender_description"]),
    ("rel-trial",  "eligibilities", "child",  ["adult","older_adult","minimum_age","maximum_age","population","criteria","gender_description"]),
    ("rel-event",  "event_interest","not_interested", ["interested"]),
]

autocomplete_reg_tasks = [
    ("rel-amazon", "review",                "rating",   ["review_text","summary"]),
    ("rel-f1",     "results",               "position", ["statusId","positionOrder","points","laps","milliseconds","fastestLap","rank"]),
...
all_tasks     = forecast_clf_tasks + forecast_reg_tasks + autocomplete_clf_tasks + autocomplete_reg_tasks
forecast_tasks = forecast_clf_tasks + forecast_reg_tasks

all_dbs = ["rel-amazon","rel-hm","rel-stack","rel-avito","rel-event","rel-trial","rel-f1"]
